"""
Program that finds the shortest path
Hit the ‘l’ key to switch to the ‘add lava tiles’ mode. T
hen you can click on any cell to add or remove a lava tile from that cell.
Hit the spacebar at any time to have Paul plan (or replan) his path to the cake, and highlight that path.
"""
import pygame
